      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active " href="Job portal admin.php">Job Portal</a>
            </li>
  ...
  <div class="job-position"><?= $row["jobPosition"] ?>
    ...
    <div class="row">
      <div class=" col-sm-3 col-md-3" style="float:right">
        <a href="jobDetailsPageAdmin.html" class="btn btn-outline-secondary jobDetailsPage" >View Details </a>  
      </div>
